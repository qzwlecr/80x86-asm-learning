...
data segment use16
	...
	shop1_goods Goods <'PEN',3,0,1000,70,25,0>,<'BOOK',4,12,30,25,5,0>,N-2 dup(<'Temp-Value',10,15,20,30,2,0>)
	shop2_name db 'SHOP2',0
	shop2_goods Goods <'PEN',3,0,1000,70,25,0>,<'BOOK',4,12,30,25,5,0>,N-2 dup(<'Temp-Value',10,15,20,30,2,0>)
	auth db 0
data ends
...
shop1_search_loop:
	...
	;jz shop1_found
assume si:ptr Goods
	mov cx, [si].goods_name_length
assume si:nothing
	push si
	push di
	mov di, offset in_goods
	repe cmpsb
	cmp cx, 0
	pop di
	pop si
